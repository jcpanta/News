...
public class bottom_fragment_home extends Fragment {
    ...
    private  com.iaovy.dream.bottom_fragment_home.MyAdapter home_adapter;
    private String[] home_title = {"推荐","资讯","论坛"};


    public static com.iaovy.dream.bottom_fragment_home createFragment(Context main_home){
        context = main_home;
        return new com.iaovy.dream.bottom_fragment_home();
    }
    @Override
    @Nullable
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        home_list.add(com.iaovy.dream.home_zixun.createFragment(this));
        home_list.add(com.iaovy.dream.home_luntan.createFragment(this));
