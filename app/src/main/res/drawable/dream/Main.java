...
public class Main extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fgLists.add(com.iaovy.dream.bottom_fragment_like.createFragment(this));
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
                switch (menuItem.getItemId()) {
                    case R.id.side_account:
                        startActivity(new Intent(com.iaovy.dream.Main.this, com.iaovy.dream.Side_account.class));
                        break;
                    case R.id.side_score:
                        startActivity(new Intent(com.iaovy.dream.Main.this, com.iaovy.dream.Side_score.class));
                        break;
                    case R.id.side_notifications:
                        startActivity(new Intent(com.iaovy.dream.Main.this, Side_notifications.class));
                        break;
                    case R.id.side_privacy:
                        startActivity(new Intent(com.iaovy.dream.Main.this, Side_privacy.class));
                        break;
                    case R.id.side_general:
                        startActivity(new Intent(com.iaovy.dream.Main.this, com.iaovy.dream.Side_general.class));
                        break;
                    case R.id.side_about:
                        //startActivity(new Intent(Main.this, Side_about.class));
                        Toast.makeText(com.iaovy.dream.Main.this,"暂不支持",Toast.LENGTH_SHORT).show();
                        break;
                    case R.id.side_help:
                        ...
                        break;
                    case R.id.side_out:
                        startActivity(new Intent(com.iaovy.dream.Main.this, com.iaovy.dream.Login.class));
                        finish();
                        break;
                }
