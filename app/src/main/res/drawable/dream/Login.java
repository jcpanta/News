        ...
        public void onClick(View view) {
            switch (view.getId()){
                ...
                case R.id.login_sign:
                    startActivity(new Intent(com.iaovy.dream.Login.this,Sign.class));
                    break;
            }
        }
    };
    public void login(){
        if(isUserNameAndPwdValid()){
            ...
            if (result == 1) {
                ...
                startActivity(new Intent(com.iaovy.dream.Login.this, Main.class));
                Toast.makeText(com.iaovy.dream.Login.this, "登陆成功", Toast.LENGTH_SHORT).show();
                finish();
            }else if (result == 0){
                Toast.makeText(com.iaovy.dream.Login.this,"账号或密码不正确",Toast.LENGTH_SHORT).show();
            }
        }
    }
    public boolean isUserNameAndPwdValid(){
        if(mAccount.getText().toString().trim().equals("")){
            Toast.makeText(com.iaovy.dream.Login.this,"请输入你的账号",Toast.LENGTH_SHORT).show();
            return false;
        }else if (mPwd.getText().toString().trim().equals("")){
            Toast.makeText(com.iaovy.dream.Login.this,"请输入你的密码",Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
